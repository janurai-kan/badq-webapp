...
* ระบบต่อคิว FIFO (First-In-First-Out): อ้างอิงจากตัวแปร `queuedAt` ใครเล่นเสร็จหรือเข้ามาใหม่ต้องไปต่อท้ายแถว
...
* **Queue Info Modal:** ป๊อปอัปอธิบายกติกา FIFO และความหมายของป้ายสถานะคิวแต่ละแบบ
